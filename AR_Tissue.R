...
# Get AR values from each data frame
Get_AR <- function(x){
  res <- as.numeric(x[which(x['gene_name'] == 'AR'),][,-c(1:2)]) # drop gene_id and gene_name cols
  return(res)
}
...
length(f.AR_Tissue_Counts) # 51
length(m.AR_Tissue_Counts) # 47

# Are all the same individuals listed in both lists?
all(names(f.AR_Tissue_Counts) == names(f.MeanX_Tissue_Counts)) # TRUE
all(names(m.AR_Tissue_Counts) == names(m.MeanX_Tissue_Counts)) # TRUE
...
Res_f.MeanX_AR <- lapply(lm_f.MeanX_AR, Regression_Res)
Res_m.MeanX_AR <- lapply(lm_m.MeanX_AR, Regression_Res)

# Make table summarizing results
f.Regression <- as.data.frame(do.call(rbind, Res_f.MeanX_AR))
m.Regression <- as.data.frame(do.call(rbind, Res_m.MeanX_AR))
...
f.Tuk_Res_Silenced_AR <- lapply(f.lm_Tuk_Silenced_AR, Regression_Res)
f.Bal_Res_Silenced_AR <- lapply(f.lm_Bal_Silenced_AR, Regression_Res)
f.One_Res_Silenced_AR <- lapply(f.lm_One_Silenced_AR, Regression_Res)
f.Immune_Res_Silenced_AR <- lapply(f.lm_Immune_Silenced_AR, Regression_Res)

m.Res_Silenced_AR <- lapply(m.lm_Silenced_AR, Regression_Res)
m.Tuk_Res_Silenced_AR <- lapply(m.lm_Tuk_Silenced_AR, Regression_Res)
m.Bal_Res_Silenced_AR <- lapply(m.lm_Bal_Silenced_AR, Regression_Res)
m.One_Res_Silenced_AR <- lapply(m.lm_One_Silenced_AR, Regression_Res)
m.Immune_Res_Silenced_AR <- lapply(m.lm_Immune_Silenced_AR, Regression_Res)
...
f.Regression$pval_Silenced_Mean <- lapply(f.Res_Silenced_AR, Return_pval)
f.Regression$R2_Silenced_Mean <- lapply(f.Res_Silenced_AR, Return_R2)

f.Regression$pval_Tuk_Silenced_Mean <- lapply(f.Tuk_Res_Silenced_AR, Return_pval)
f.Regression$R2_Tuk_Silenced_Mean <- lapply(f.Tuk_Res_Silenced_AR, Return_R2)

f.Regression$pval_Bal_Silenced_Mean <- lapply(f.Bal_Res_Silenced_AR, Return_pval)
f.Regression$R2_Bal_Silenced_Mean <- lapply(f.Bal_Res_Silenced_AR, Return_R2)

f.Regression$pval_One_Silenced_Mean <- lapply(f.One_Res_Silenced_AR, Return_pval)
f.Regression$R2_One_Silenced_Mean <- lapply(f.One_Res_Silenced_AR, Return_R2)

f.Regression$pval_Immune_Silenced_Mean <- lapply(f.Immune_Res_Silenced_AR, Return_pval)
f.Regression$R2_Immune_Silenced_Mean <- lapply(f.Immune_Res_Silenced_AR, Return_R2)

m.Regression$pval_Silenced_Mean <- lapply(m.Res_Silenced_AR, Return_pval)
m.Regression$R2_Silenced_Mean <- lapply(m.Res_Silenced_AR, Return_R2)

m.Regression$pval_Tuk_Silenced_Mean <- lapply(m.Tuk_Res_Silenced_AR, Return_pval)
m.Regression$R2_Tuk_Silenced_Mean <- lapply(m.Tuk_Res_Silenced_AR, Return_R2)

m.Regression$pval_Bal_Silenced_Mean <- lapply(m.Bal_Res_Silenced_AR, Return_pval)
m.Regression$R2_Bal_Silenced_Mean <- lapply(m.Bal_Res_Silenced_AR, Return_R2)

m.Regression$pval_One_Silenced_Mean <- lapply(m.One_Res_Silenced_AR, Return_pval)
m.Regression$R2_One_Silenced_Mean <- lapply(m.One_Res_Silenced_AR, Return_R2)
...
f.Res_Tuk_Variable_AR <- lapply(f.lm_Tuk_Variable_AR, Regression_Res)
f.Res_Bal_Variable_AR <- lapply(f.lm_Bal_Variable_AR, Regression_Res)
f.Res_Immune_Variable_AR <- lapply(f.lm_Immune_Variable_AR, Regression_Res)

m.Res_One_Variable_AR <- lapply(m.lm_One_Variable_AR, Regression_Res)
m.Res_Tuk_Variable_AR <- lapply(m.lm_Tuk_Variable_AR, Regression_Res)
m.Res_Bal_Variable_AR <- lapply(m.lm_Bal_Variable_AR, Regression_Res)
m.Res_Immune_Variable_AR <- lapply(m.lm_Immune_Variable_AR, Regression_Res)

# Add vector as column to df
f.Regression$pval_One_Variable_Mean <- lapply(f.Res_Silenced_AR, Return_pval)
f.Regression$R2_One_Variable_Mean <- lapply(f.Res_Silenced_AR, Return_R2)

f.Regression$pval_Tuk_Variable_Mean <- lapply(f.Res_Tuk_Variable_AR, Return_pval)
f.Regression$R2_Tuk_Variable_Mean <- lapply(f.Res_Tuk_Variable_AR, Return_R2)

f.Regression$pval_Bal_Variable_Mean <- lapply(f.Res_Bal_Variable_AR, Return_pval)
f.Regression$R2_Bal_Variable_Mean <- lapply(f.Res_Bal_Variable_AR, Return_R2)

f.Regression$pval_Immune_Variable_Mean <- lapply(f.Res_Immune_Variable_AR, Return_pval)
f.Regression$R2_Immune_Variable_Mean <- lapply(f.Res_Immune_Variable_AR, Return_R2)

m.Regression$pval_One_Variable_Mean <- lapply(m.Res_Silenced_AR, Return_pval)
m.Regression$R2_One_Variable_Mean <- lapply(m.Res_Silenced_AR, Return_R2)

m.Regression$pval_Tuk_Variable_Mean <- lapply(m.Res_Tuk_Variable_AR, Return_pval)
m.Regression$R2_Tuk_Variable_Mean <- lapply(m.Res_Tuk_Variable_AR, Return_R2)

m.Regression$pval_Bal_Variable_Mean <- lapply(m.Res_Bal_Variable_AR, Return_pval)
m.Regression$R2_Bal_Variable_Mean <- lapply(m.Res_Bal_Variable_AR, Return_R2)
...
f.Res_Tuk_Incomplete_AR <- lapply(f.lm_Tuk_Incomplete_AR, Regression_Res)
f.Res_Bal_Incomplete_AR <- lapply(f.lm_Bal_Incomplete_AR, Regression_Res)
f.Res_Immune_Incomplete_AR <- lapply(f.lm_Immune_Incomplete_AR, Regression_Res)

m.Res_Tuk_Incomplete_AR <- lapply(m.lm_Tuk_Incomplete_AR, Regression_Res)
m.Res_One_Incomplete_AR <- lapply(m.lm_One_Incomplete_AR, Regression_Res)
m.Res_Bal_Incomplete_AR <- lapply(m.lm_Bal_Incomplete_AR, Regression_Res)
m.Res_Immune_Incomplete_AR <- lapply(m.lm_Immune_Incomplete_AR, Regression_Res)

# Add vector as column to df
f.Regression$pval_One_Incomplete_Mean <- lapply(f.Res_One_Incomplete_AR, Return_pval) 
f.Regression$R2_One_Incomplete_Mean <- lapply(f.Res_One_Incomplete_AR, Return_R2) 

f.Regression$pval_Tuk_Incomplete_Mean <- lapply(f.Res_Tuk_Incomplete_AR, Return_pval)
f.Regression$R2_Tuk_Incomplete_Mean <- lapply(f.Res_Tuk_Incomplete_AR, Return_R2)

f.Regression$pval_Bal_Incomplete_Mean <- lapply(f.Res_Bal_Incomplete_AR, Return_pval)
f.Regression$R2_Bal_Incomplete_Mean <- lapply(f.Res_Bal_Incomplete_AR, Return_R2)

f.Regression$pval_Immune_Incomplete_Mean <- lapply(f.Res_Immune_Incomplete_AR, Return_pval)
f.Regression$R2_Immune_Incomplete_Mean <- lapply(f.Res_Immune_Incomplete_AR, Return_R2)

m.Regression$pval_One_Incomplete_Mean <- lapply(m.Res_One_Incomplete_AR, Return_pval) 
m.Regression$R2_One_Incomplete_Mean <- lapply(m.Res_One_Incomplete_AR, Return_R2) 

m.Regression$pval_Tuk_Incomplete_Mean <- lapply(m.Res_Tuk_Incomplete_AR, Return_pval)
m.Regression$R2_Tuk_Incomplete_Mean <- lapply(m.Res_Tuk_Incomplete_AR, Return_R2)

m.Regression$pval_Bal_Incomplete_Mean <- lapply(m.Res_Bal_Incomplete_AR, Return_pval)
m.Regression$R2_Bal_Incomplete_Mean <- lapply(m.Res_Bal_Incomplete_AR, Return_R2)
...
f.Regression$sd_AR <- lapply(f.AR_Tissue_Counts, sd)
m.Regression$sd_AR <- lapply(m.AR_Tissue_Counts, sd)
...
f.Slopes <- lapply(lm_f.MeanX_AR, function(x){
  res <- x[[1]][[2]]
  return(res)
})

m.Slopes <- lapply(lm_m.MeanX_AR, function(x){
  res <- x[[1]][[2]]
  return(res)
})
...
f.tmp_MeanX_AR <- f.MeanX_Vs_AR[Shared]
m.tmp_MeanX_AR <- m.MeanX_Vs_AR[Shared]

# Check lists are in same order
identical(names(f.tmp_MeanX_AR), names(m.tmp_MeanX_AR)) # TRUE
